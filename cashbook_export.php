...
fputcsv($out, ['ma_phieu', 'loai', 'ly_do', 'hinh_thuc_tt', 'chi_nhanh', 'nguoi_tao', 'ngay', 'so_tien']);
foreach ($entries as $en) {
    fputcsv($out, [
        $en['code'], $typeLabels[$en['type']] ?? $en['type'], $en['reason'],
        $paymentLabels[$en['payment_method']] ?? $en['payment_method'], $en['branch_name'], $en['created_by_name'],
